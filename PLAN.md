...
- johnanvik, *devops-colouring* repository (template, labels, workflow), `https://github.com/johnanvik/devops-colouring`
- Pylayeva, Dana (2024). *DevSecOps Adventures: A Game-Changing Approach with Chocolate, LEGO, and Coaching Games*. `https://doi.org/10.1007/979-8-8688-0397-0`
...
SUPABASE_SETUP.md            # step-by-step backend creation
DEPLOYMENT.md                # Cloudflare Pages deploy steps
