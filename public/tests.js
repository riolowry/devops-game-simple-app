  ...
  if (!window.CONFIG || !window.CONFIG.SUPABASE_URL || window.CONFIG.SUPABASE_URL.includes("YOUR-PROJECT-REF")) {
    document.addEventListener("DOMContentLoaded", () => {
      document.body.innerHTML =
        ...
        'Set your Supabase URL and anon key. See <a href="https://github.com/riolowry/devops-game-simple-app/blob/main/setup_resources/SETUP_SUPABASE_DB.md">setup_resources/SETUP_SUPABASE_DB.md</a> in the repository for more information.</p></div>';
    });
    return;
  }
